...
const dict = {
  es: {
    ...
    'room.checklistClear': 'Eliminar',
    'room.checklistClearConfirmTitle': 'Eliminar checklist',
    'room.checklistClearConfirmBody': 'Se borran todos los puntos de esta checklist para este tipo de trabajo. No afecta a las tareas ya creadas.',
    'room.checklistCleared': 'Checklist eliminada',
    ...
    'lost.room': 'Ubicación',
    'lost.pickLocation': 'Selecciona la ubicación',
    'lost.roomOption': 'Habitación',
    'lost.roomNumberPlaceholder': 'Número de habitación (ej.: 101)',
    'lost.roomNumberInvalid': 'No existe esa habitación',
    'lost.timeInvalid': 'Hora no válida (00:00 - 23:59)',
    ...
    'inventory.noResults': 'Sin resultados para esta búsqueda o filtro.',
    'inventory.clearFilters': 'Quitar filtros',
    'inventory.lowFilter': 'Bajo mínimo',
    'inventory.existingCategories': 'Categorías existentes',
    'inventory.itemCount': '{n} artículos',
    ...
    'bulk.checklistHint': 'Empieza en blanco. Lo que escribas aquí queda como la checklist individual de cada sitio elegido.',
  ...
  en: {
    ...
    'room.checklistClear': 'Delete',
    'room.checklistClearConfirmTitle': 'Delete checklist',
    'room.checklistClearConfirmBody': 'Every point of this checklist for this work type gets removed. Tasks already created are unaffected.',
    'room.checklistCleared': 'Checklist deleted',
    ...
    'lost.room': 'Location',
    'lost.pickLocation': 'Select the location',
    'lost.roomOption': 'Room',
    'lost.roomNumberPlaceholder': 'Room number (e.g.: 101)',
    'lost.roomNumberInvalid': "That room doesn't exist",
    'lost.timeInvalid': 'Invalid time (00:00 - 23:59)',
    ...
    'inventory.searchPlaceholder': 'Search item...',
    'inventory.noResults': 'No results for this search or filter.',
    'inventory.clearFilters': 'Clear filters',
    'inventory.lowFilter': 'Below minimum',
    'inventory.existingCategories': 'Existing categories',
    'inventory.itemCount': '{n} items',
    ...
    'bulk.checklist': 'Checklist',
    'bulk.checklistHint': "Starts blank. What you write here becomes the individual checklist of every place picked.",
